...
readonly class="form-control"/>
 ...
 <input type="text" name="nomPatient" value="${patient.nomPatient}"
class="form-control"/>
 </div>
 <div class="form-group">
 <label class="control-label">Prix consultation :</label>
 <input type="text" name="prixConsultation" value="${patient.prixConsultation}"
class="form-control"/>
 </div>
 <div class="form-group">
